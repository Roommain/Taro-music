...
var Index = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Index() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Index.__proto__ || Object.getPrototypeOf(Index)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray12", "$compid__19", "coverImgUrl", "songId", "showList", "status", "isPlay", "reserveList"], _this.config = {
  ...
  _createClass(Index, [{
    ...
    value: function getRankingList(id) {
      ...
      _index2.default.request({
        ...
        _this2.setState({
          coverImgUrl: res.data.album.blurPicUrl,
          showList: res.data.songs,
          status: 'noMore'
        });
        _index2.default.setStorageSync('songList', res.data.songs);
      });
    }
  }, {
    key: "handleClick",
    ...
    value: function _createData() {
      ...
      var loopArray12 = showList.map(function (item, index) {
        item = {
          $original: (0, _index.internal_get_original)(item)
        };

        var _$indexKey = "bgzzz" + index;

        _this4.anonymousFunc0Map[_$indexKey] = function () {
          return _this4.play(item.$original.id);
        };

        var _genCompid3 = (0, _index.genCompid)(__prefix + "bhzzzzzzzz" + index, true),
  ...
  return Index;
}(_index.Component), _class.$$events = ["anonymousFunc0"], _class.$$componentPath = "pages/music/albumList/index", _temp2);
